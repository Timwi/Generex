...
namespace RT.Generexes
{
    ...
    public static class Generex
    {
        ...
        /// <summary>
        /// Attempts to match the specified element and throws an exception generated by the specified code if the regular expression does not match.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to match the specified element using the specified comparer and throws an exception generated by the specified code if the regular expression does not match.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to match the specified sequence of elements and throws an exception generated by the specified code if the regular expression does not match.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to match the specified sequence of elements using the specified comparer and throws an exception generated by the specified code if the regular expression does not match.
        /// </summary>
