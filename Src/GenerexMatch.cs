...
namespace RT.Generexes
{
    ...
    {
        /// <summary>Gets the index in the original collection at which the match occurred.</summary>
        public int Index { get; private set; }

        /// <summary>Gets the length of the match.</summary>
        public int Length { get; private set; }

        /// <summary>Gets the entire original sequence against which the regular expression was matched.</summary>
        public T[] OriginalSource { get; private set; }

        /// <summary>Returns a slice of the original collection which the regular expression matched.</summary>
    ...
    /// <summary>Represents the result of a regular expression match using <see cref="Stringerex"/>.</summary>
    public class StringerexMatch : GenerexMatch<char>
    {
        /// <summary>Gets the entire original string against which the regular expression was matched.</summary>
        public new string OriginalSource { get { return _originalSource ?? (_originalSource = new string(base.OriginalSource)); } }
        private string _originalSource;

        /// <summary>Returns the part of the original string which the regular expression matched.</summary>
    ...
    /// <summary>
    ///     Represents the result of a regular expression match using <see cref="Generex{T,TResult}"/>.</summary>
    /// <typeparam name="T">
    ///     Type of the objects in the collection.</typeparam>
    /// <typeparam name="TResult">
    ///     Type of the result object associated with this regular expression match.</typeparam>
    ...
    /// <summary>
    ///     Represents the result of a regular expression match using <see cref="Stringerex{TResult}"/>.</summary>
    /// <typeparam name="TResult">
    ///     Type of the result object associated with this regular expression match.</typeparam>
