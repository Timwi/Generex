...
namespace RT.Generexes
{
    ...
    public static class Generex
    {
        ...
        /// <summary>
        ///     Instantiates a regular expression that matches a sequence of consecutive elements.</summary>
        /// <typeparam name="T">
        ...
        ///     Type of the objects in the collection against which the regular expression will be matched.</typeparam>
        /// <param name="comparer">
        ///     Equality comparer to determine matching elements.</param>
        /// <param name="elements">
        ///     The sequence of elements to match.</param>
        ...
        ///     Predicate that determines whether an element matches.</param>
        public static Generex<T> New<T>(Predicate<T> predicate) { return new Generex<T>(predicate); }
        /// <summary>
        ///     Instantiates a regular expression that matches a sequence of consecutive regular expressions.</summary>
        /// <typeparam name="T">
        ///     Type of the objects in the collection against which the regular expression will be matched.</typeparam>
        /// <param name="generexes">
        ///     Sequence of regular expressions to match.</param>
        ...
        /// <summary>
        ///     Generates a regular expression that matches the specified elements in any order.</summary>
        /// <typeparam name="T">
        ...
        /// <typeparam name="T">
        ///     Type of objects that the regular expression will later match against.</typeparam>
        /// <param name="input">
        ...
        ///     <c>?</c> in traditional regular expression syntax).</summary>
        /// <typeparam name="T">
        ///     The type of objects being matched.</typeparam>
        /// <typeparam name="TResult">
        ///     Type of the result object associated with each match of the regular expression.</typeparam>
        /// <param name="inner">
        ///     The regular expression to be modified.</param>
        /// <returns>
        ...
        /// <summary>
        ///     Converts the specified <see cref="Generex{T}"/> to an equivalent regular expression of type <see
        ///     cref="Stringerex"/>.</summary>
        ...
        /// <summary>
        ///     Converts the specified <see cref="Generex{T,TResult}"/> to an equivalent regular expression of type <see
        ///     cref="Stringerex{TResult}"/>.</summary>
        ...
        ///     the first match; otherwise, returns <c>null</c>.</summary>
        /// <param name="generex">
        ...
        ///     Optional index at which to start the search. Matches that start before this index are not included.</param>
        /// <returns>
        ///     The result of the first match in case of success; <c>null</c> if no match.</returns>
        ...
        /// <summary>
        ///     Determines whether the given input sequence matches this regular expression, and if so, returns the result of
        ///     the first match found by matching the regular expression backwards; otherwise, returns <c>null</c>.</summary>
        /// <param name="generex">
        ///     The current regular expression.</param>
        /// <param name="input">
        ///     Input sequence to match the regular expression against.</param>
        ...
        /// <returns>
        ///     The result of the match in case of success; <c>null</c> if no match.</returns>
